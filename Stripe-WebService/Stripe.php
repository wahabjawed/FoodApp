...
Stripe::setApiKey("sk_test_4aZGpv5nUUYMM58ffIdzhbJf");

// Get the credit card details submitted by the form
$token = $_POST['parameterOne'];
$amount = $_POST['parameterTwo']*100;

echo "TOKEN in PHP : $token";
...
$charge = Stripe_Charge::create(array(
  ...
  "currency" => "usd",
  "card" => $token,
  "description" => "zohairhemani@avialdo.com")
);
